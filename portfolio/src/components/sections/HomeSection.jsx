...
const HomeSection = ({ setSection }) => {
  return (
    <div className="lg:pt-[10%] md:pt-[14%] flex md:px-[10%] pt-[18%] px-[5%]">
      <div className="lg:w-[100%] md:ml-0 md:w-[100%] ml-0 w-[100%] flex bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] shadow-lg rounded-xl border border-white border-opacity-20 p-4">
