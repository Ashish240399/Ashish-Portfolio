...
const Contact = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center pt-[7%]'>
      <div className='md:text-[30px] text-[20px] font-bold w-full md:px-[10%] px-[5%]'>
        Contact
      </div>
      <div className='w-full md:px-[10%] px-[5%] text-[14px] md:text-[16px]'>
      ...
      <form
        ref={formRef}
        onSubmit={sendEmail}
        className='p-5 bg-[rgba(255,255,255,0.1)] backdrop-blur-[10px] rounded-lg shadow-lg w-[90%] max-w-[500px] text-[14px] md:text-[16px]'>
        <div className='mb-4'>
